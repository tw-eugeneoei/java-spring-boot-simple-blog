...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
  ...
  @Override
  // this method is called whenever an exception is thrown due to an unauthorised/unauthenticated
  ...
  public void commence(
    ...
    // AccessDeniedException is thrown and tried to catch in GlobalExceptionHandler but no match was
    // found
