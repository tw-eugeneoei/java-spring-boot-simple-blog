...
// @ResponseStatus annotation cause speing boot to respond with the specified HTTP status code
// whenever this exception
  ...
  public ResourceNotFoundException(String resourceName, String fieldName, UUID fieldValue) {
    super(
        String.format(
            ...
            resourceName, fieldName, fieldValue)); // eg: Post not found with id: 1
